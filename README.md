...
When the evolution begins, intense battles begin along with it; bodies do their best to populate as much room as possible for their species to win; some of them become passive eating plants and procreating, some of them become aggressive trying to attack the bodies of other species.
<br>
...
Whenever a body goes over a plant or another body, the body that did it gets 100 points to its energy if the plant was trodden, otherwise it gets the energy of the body that was trodden.
...
If you click a circle, then this circle turns into a triangle, and the bodies of further generations of the species of this body are also triangles.

If you click a square-shaped body (the body the species of which the AI thinks will survive the evolution), then the shape of this body becomes a rhombus and you are not able to adjust the behaviour of the species of this body. Just like with triangles, the further generations of the species of this body will retain the shape of their parents.
...
To see the vision distance more clearly, in the checkbox beneath "Which body properties to display", you can select "Vision distance" and see the circles around the bodies which show the vision distance.
<br>
...
* Selected species:
  ...
  * Don't eat plants: the species you think will survive the evolution must not eat plants
...
# More about the properties of the bodies <a id="more-properties"></a>
Inborn properties:
...
The algorithm of defining what is going to be eaten by a body: plant-eaters try to find plants within their vision distance, but if there are no plants within their vision distance, then they try to find bodies within their vision distance, and the same, but vice versa, for body-eaters. Neither body-eaters nor plant-eaters betray the bodies with the same species: if the plant or the body is already being followed by a body with the same species, then this body or plant is qualified as unsuitable.

## Speed <a id="more-speed"></a>
Speed is quite ambiguous: high speed makes bodies lose more energy on moving (the higher the speed is, the more energy is spent on moving), but they can reach plants and other bodies faster, whereas low speed lets bodies lose a low amount of energy on moving, but they might sometimes not cope with escaping from a body which is chasing them or not be able to catch a body themselves.

## Vision distance <a id="more-vision-distance"></a>
Vision distance determines the distance from the body at which it can seek plants and other bodies. The algorithm that the higher the value is, the more energy is spent, works for vision distance too.

## Procreation threshold <a id="more-procreation-threshold"></a>
Procreation threshold is the threshold of energy that has to be exceeded for the body to procreate. A high procreation threshold might be good because children take a half of the energy of their parent, and a low procreation threshold might be good because the body procreates quite soon.

## Energy <a id="more-energy"></a>
Each time the body moves, the energy is spent for vision distance and speed (the higher the value is, the more is spent).
...
The AI is used for selecting the species it thinks will survive the evolution. One of the bodies has the shape of a square, and this square-shaped body is the one the AI thinks will have its species survive the evolution.

## How often does the AI predict the survivor species correctly?
The averaged percent from 2000 evolutions is 60% (note that this percent is taken from the evolutions in which there was no species selected by the user).

## Is the AI used beyond the process of selecting the species?
...
* Smart plant chasing:
  ...
  * if a body from a different species is following that plant, if it can catch that plant earlier, then nothing is done
...
* Smart body chasing:
  ...
  * If a body from a different species is following that body, if it can catch that body earlier, then nothing is done
