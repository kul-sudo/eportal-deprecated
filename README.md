...
The averaged percent from 2000 evolutions is 60% (note that this percent is taken from evolutions in which there was no species selected by the user, therefore the behaviour was never changed)
